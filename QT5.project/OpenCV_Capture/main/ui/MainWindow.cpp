	...
	ui(new Ui::MainWindow)
{
	...
	addCodecs();
	this->setWindowTitle(MyUtils::stringMyTitle());
}
...
void MainWindow::showAboutDialog()
{
	...
	ts << "<h3>Realtime Video Capture</h3> <p>" <<
	   MyUtils::stringMyTitle() <<
	   "</p><p>This is an OpenCV and Qt based realtime application to process videos and camerastreams.</p>";
...
void MainWindow::showHelpDialog()
{
	...
	ts << "<p>The best way to understand is experimenting with the sliders. </p><p>If you should encounter " <<
	   "crashs while processing video, try a lower resolution or change ROI (draw a box in the frame label).</p>";
